...
import ani.saikou.app.android.adapter.media.TitleAdapter
import ani.saikou.app.android.model.media.OtherDetailsViewModel
import ani.saikou.app.databinding.ActivityStudioBinding
        ...
        model.getStudio().observe(this) {
            if (it != null) {
                ...
                for (i in keys.indices) {
                    ...
                    concatAdapter.addAdapter(MediaAdapter(0, medias, this, true))
