...
import ani.saikou.app.android.fragment.media.MediaListDialogSmallFragment
import ani.saikou.app.databinding.ItemMediaCompactBinding
import ani.saikou.app.databinding.ItemMediaLargeBinding
import ani.saikou.app.databinding.ItemMediaPageBinding
import ani.saikou.app.databinding.ItemMediaPageSmallBinding
import ani.saikou.app.util.loadData
import ani.saikou.app.util.loadImage
import ani.saikou.app.util.setAnimation
import ani.saikou.app.util.setSafeOnClickListener
            ...
            0 -> {
                ...
                if (media != null) {
                    ...
                    if (media.anime != null) {
                        ...
                        b.itemCompactTotal.text = buildString {
                            append(" | ")
                            if (anime.nextAiringEpisode != null) {
                                append(anime.nextAiringEpisode)
                                append(" | ")
                            }
