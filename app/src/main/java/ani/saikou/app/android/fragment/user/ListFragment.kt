package ani.saikou.app.android.fragment.user
...
import ani.saikou.app.databinding.FragmentListBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fun update() {
            if (grid != null && list != null) {
                val adapter = MediaAdapter(if (grid!!) 0 else 1, list!!, requireActivity(), true)
