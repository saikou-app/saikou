package ani.saikou.app.android.fragment.manga
...
import ani.saikou.app.android.activity.manga.MangaReaderActivity
import ani.saikou.app.android.adapter.manga.MangaChapterAdapter
import ani.saikou.app.android.adapter.manga.MangaReadAdapter
...
open class MangaReadFragment : Fragment() {
    ...
    val uiSettings = STORE.loadData("ui_settings", false)
        ?: UserInterfaceSettings().apply { STORE.saveData("ui_settings", this) }
    ...
    fun onMangaChapterClick(i: String) {
        ...
        if (media.manga?.chapters?.get(i) != null) {
            ...
            val intent =
                Intent(activity, MangaReaderActivity::class.java).apply { putExtra("media", media) }
