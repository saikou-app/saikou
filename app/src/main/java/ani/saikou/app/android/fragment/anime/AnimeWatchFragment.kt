...
open class AnimeWatchFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        playerSettings = STORE.loadData("player_settings", false)
            ?: PlayerSettings().apply { STORE.saveData("player_settings", this) }
        uiSettings = STORE.loadData("ui_settings", false)
