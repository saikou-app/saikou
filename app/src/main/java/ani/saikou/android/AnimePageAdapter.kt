...
import ani.saikou.android.databinding.ItemAnimePageBinding
import ani.saikou.android.media.MediaAdaptor
import ani.saikou.android.media.SearchActivity
import ani.saikou.android.settings.SettingsDialogFragment
...
class AnimePageAdapter : RecyclerView.Adapter<AnimePageAdapter.AnimePageViewHolder>() {
    ...
    fun updateRecent(adaptor: MediaAdaptor) {
        ...
        binding.animeUpdatedRecyclerView.layoutManager = LinearLayoutManager(
