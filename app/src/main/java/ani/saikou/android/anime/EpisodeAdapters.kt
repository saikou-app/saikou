...
import ani.saikou.android.databinding.ItemEpisodeCompactBinding
import ani.saikou.android.databinding.ItemEpisodeGridBinding
import ani.saikou.android.databinding.ItemEpisodeListBinding
import ani.saikou.android.loadData
import ani.saikou.core.model.media.Media
import ani.saikou.android.setAnimation
import ani.saikou.android.updateAnilistProgress
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        when (holder) {
            is EpisodeListViewHolder -> {
                ...
                Glide.with(binding.itemEpisodeImage).load(ep.thumb ?: media.cover).override(400, 0)
