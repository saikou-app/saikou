package ani.saikou.android.manga
...
import ani.saikou.android.anime.handleProgress
import ani.saikou.android.databinding.ItemAnimeWatchBinding
import ani.saikou.android.databinding.ItemChipBinding
import ani.saikou.android.loadData
import ani.saikou.android.loadImage
import ani.saikou.android.manga.source.MangaReadSources
import ani.saikou.android.media.SourceSearchDialogFragment
import ani.saikou.android.px
    ...
    fun handleChapters() {
        ...
        if (binding != null) {
            if (media.manga?.chapters != null) {
                ...
                val chapters = manga.chapters!!.keys.toTypedArray()
                var continueEp =
                    loadData<String>("${media.id}_current_chp") ?: media.userProgress?.plus(1)
                        .toString()
                if (chapters.contains(continueEp)) {
                    ...
                    val ep = manga.chapters!![continueEp]!!
