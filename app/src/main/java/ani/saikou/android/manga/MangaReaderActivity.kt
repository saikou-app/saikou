...
import ani.saikou.android.databinding.ActivityMangaReaderBinding
import ani.saikou.android.manga.source.HMangaSources
import ani.saikou.android.manga.source.MangaSources
...
class MangaReaderActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        settings = loadData("reader_settings") ?: ReaderSettings().apply {
            saveData(
                "reader_settings",
                this
            )
