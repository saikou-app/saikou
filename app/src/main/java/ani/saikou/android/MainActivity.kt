...
import ani.saikou.android.anilist.AnilistHomeViewModel
import ani.saikou.android.databinding.ActivityMainBinding
import ani.saikou.android.media.MediaDetailsActivity
import ani.saikou.android.others.AppUpdater
import ani.saikou.android.others.DisableFirebase
...
//                        toastString("Error Loading Tags & Genres.")
    ...
    override fun onBackPressed() {
        ...
        val snackBar =
            Snackbar.make(binding.root, "Please click BACK again to exit", Snackbar.LENGTH_LONG)
        snackBar.view.translationY =
            -navBarHeight.dp - if (binding.navbar.scaleX == 1f) binding.navbar.height - 2f else 0f
        snackBar.show()
